        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaiViets_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BaiVietsId = table.Column<int>(type: "int", nullable: false),
                    TagsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaiVietTag", x => new { x.BaiVietsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_BaiVietTag_BaiViets_BaiVietsId",
                        column: x => x.BaiVietsId,
                        principalTable: "BaiViets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaiVietTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaiVietTags", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaiViets_ApplicationUserId",
                table: "BaiViets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaiVietTag_TagsId",
                table: "BaiVietTag",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_BaiVietTags_BaiVietId",
                table: "BaiVietTags",
                column: "BaiVietId");
